...
// PLANTILLA: Clásica
// Sobre animado + portada elegante + secciones estándar.
// Recibe la boda ya cargada desde PublicInvitation.jsx (el selector de plantillas).
export default function PlantillaClasica({ boda }) {
